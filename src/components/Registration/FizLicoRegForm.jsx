            ...
            <div classNameName="container">
                <form>
                    ...
                    <div classNameName="col-25 ">
                        ...
                        <input type="checkbox" checked={men} onClick={this.onMenChange} name="men"> Муж</input>
                        <input type="checkbox" checked={women} onClick={this.onWomenChange} name="women"> Жен</input>
                    </div>
                    </div>
                    ...
                    <div classNameName="row">
                        <div classNameName="col-25">
                            <label>
                                <input type="checkbox" checked="checked" name="rezident"> Не являюсь резидентом РК</input>
                            </label>
                        </div>
                        <div classNameName="col-25">
                    ...
                    <div className="row">
                        <div className="col-50">
                            <label>
                                <input type="checkbox" checked={agreement} onClick={this.onAgreementChange} name="agreement"> Ознакомлен и согласен с правилами страхования и даю согласия на сбор и обработку персоналных данных </input>
                            </label>
                            <label>
                                <input type="checkbox" checked={agreement2} onClick={this.onAgreement2Change} name="agreement2"> Не являюсь иностранным публичным должностным лицом</input>
                            </label>
                        </div>
                    </div>
